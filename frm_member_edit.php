            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">เเก้ไขข้อมูลสมาชิก</h1><br>
                                    ...
                                    <form action="sql_member.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                        ...
                                        <input type=hidden name="id" id="id" value="<?= $id ?>">
                                            <div class="form-group">
                                                ...
                                                <input  value="<?= $name1 ?>" name="name" id="name" class="form-control" required type="text">
                                            </div>
                                            <div class="form-group">
                                                <label for="recipient-name" class="col-form-label">username:</label>
                                                <input value="<?= $username1 ?>" name="username" id="username" class="form-control" onkeypress="isInputPassword(event)" required type="text">
                                            </div>
                                            <div class="form-group">
                                                <label for="recipient-name" class="col-form-label">password:</label>
                                                <input value="<?= $password1 ?>" name="password" id="password" class="form-control" onkeypress="isInputPassword(event)" required type="text">
                                            </div>
                                            <div class="form-group">
                                                <label for="recipient-name" class="col-form-label">สถานะ:</label>
                                                <label for="recipient-name" class="col-form-label">ผู้ดูแลระบบ:</label>
                                                <input <?php if ($status1 == 0) {echo "checked";} ?> type="radio" name="status" id="status" value="0" />&nbsp;&nbsp;
                                                <label for="recipient-name" class="col-form-label">ผู้ใช้ทั่วไป:</label>
                                                <input <?php if ($status1 == 1) {echo "checked";} ?> type="radio" name="status" id="status" value="1" />
                                            </div>
