...
if (isset($_SESSION["username"]) && isset($_SESSION["password"]) &&  $_SESSION["status"] == '0') {
    ...
    $query = "SELECT *,count(username) as sum FROM indicators_user where name NOT IN ('ADMIN','Admin','admin','USER','User','user');";
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <img src="img/programmer.png" width="50" height="50" id="O">
                                            </div>
                                        </div>
                                    </div>
                                </div>
